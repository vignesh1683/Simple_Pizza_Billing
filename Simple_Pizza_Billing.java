...
public class Simple_Pizza_Billing{
    public static void main(String[] args){
        ...
        double cost = 0.0; // pizza cost final double taxRate=0.08; // amount tax owed
        final double taxRate =0.08; // amount tax owned
        ...
        System.out.println("Please enter total distance in kilometers from pizza shop (0 for in store pickup): ");
        ...
        System.out.println("Additional toppings are Rs.50 each, choose from Pepperoni or Sausage." );
        ...
        // Calculations
        total = (cost) + (numberOfToppings3 * 50) + (deliveryfee);
        tax = total * taxRate;
        ...
        System.out.println("Tax: Rs." + df.format(tax));
